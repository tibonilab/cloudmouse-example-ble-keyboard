...
namespace CloudMouse::Hardware
{
    ...
    private:
        ...
        enum class Screen
        {
            ...
            /**
             * Default volume feedback screen for BLE Keyboard
             */
            VOLUME_FEEDBACK
        };
        ...
        unsigned long lastVolumeFeedbackTime = 0;  // Timestamp of last volume feedback event
        ...
        /**
         * Render volume control feedback message
         * Shows large centered text for volume changes
         * 
         * @param message Text to display (e.g. "VOLUME UP", "TOGGLE MUTE")
         */
        void renderVolumeFeedback(const String &message);
