...
enum class EventType {
    ...
    /**
     * Volume control feedback - volume decreased  
     * Usage: Display "VOLUME DOWN" message on screen
     */
    VOLUME_DOWN_FEEDBACK,

    /**
     * Volume control feedback - mute toggled
     * Usage: Display "TOGGLE MUTE" message on screen
     */
